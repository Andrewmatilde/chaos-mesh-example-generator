// Code generated by qtc from "maintemplate.qtpl". DO NOT EDIT.
// See https://github.com/valyala/quicktemplate for details.

//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:1
package controllerManager

//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:1
import "github.com/iancoleman/strcase"

//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:3
import (
	qtio422016 "io"
...
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:3
func StreamControllerManager(qw422016 *qt422016.Writer, name string) {
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:3
	qw422016.N().S(`
...
func main() {
	...
	if err = (&controllers.`)
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:172
	qw422016.E().V(strcase.ToCamel(name))
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:172
	qw422016.N().S(`ChaosReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("`)
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:174
	qw422016.E().V(strcase.ToCamel(name))
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:174
	qw422016.N().S(`Chaos"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "`)
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:176
	qw422016.E().V(strcase.ToCamel(name))
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:176
	qw422016.N().S(`Chaos")
		os.Exit(1)
...
`)
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
}

//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
func WriteControllerManager(qq422016 qtio422016.Writer, name string) {
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
	qw422016 := qt422016.AcquireWriter(qq422016)
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
	StreamControllerManager(qw422016, name)
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
...
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
func ControllerManager(name string) string {
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
	qb422016 := qt422016.AcquireByteBuffer()
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
	WriteControllerManager(qb422016, name)
//line template/chaos-mesh/cmd/controllerManager/maintemplate.qtpl:282
